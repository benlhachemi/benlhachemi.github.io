---
title: Nest Cloaker
shortDescription: Affiliate marketing URL cloaking API with device fingerprinting and network filtering.
techStack: [nestjs, typescript, mongodb]
links:
  - type: github
    url: https://github.com/benlhachemi/nest-cloaker.git
image: /images/nest-cloaker.webp
date: Apr 2023
---
# Nest Link Cloaker
